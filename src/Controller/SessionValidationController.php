...
class SessionValidationController
{
     ...
     * @return void
     */
    public static function configure($ticketExpiration = null, $validationResultProviderFactory = null)
    {
        global $resultProviderFactory, $defaultTicketExpiration;
     ...
     */
    public static function validateRequestFromConfiguration($queueName = 'default', $includeTargetUrl = null, $sslEnabled = null, $domainAlias = null, $language = null, $layoutName = null)
    {
        if ($queueName == null)
